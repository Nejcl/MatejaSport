...
if(isset($postdata) && !empty($postdata))
{
  ...
  $sql = "SELECT pt.Id,t.ID_termin,t.naziv,t.instruktor,t.barva,t.datum,t.od,t.do,pt.mesto,t.status FROM termini t LEFT JOIN rezerveTermin pt ON t.ID_termin =pt.Id_termin WHERE t.datum >='{$date_now}' AND pt.id_uporabnik = '{$user}' GROUP BY t.ID_termin ORDER BY t.datum ";
